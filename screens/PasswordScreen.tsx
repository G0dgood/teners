...
const PasswordScreen = ({ navigation }: any) => {
	...
	const handleLoginValidation = (password: string | any[]) => {
	...
	const handleLogin = async () => {
		...
		if (handleLoginValidation(password)) {
			// Valid Password (more than e characters)
			try {
				navigation.replace('Root'); // Pass data to next page (if applicable)
		...
		<ScrollView contentContainerStyle={styles.container}>
			...
			<View style={styles.logoheaderContainer}>
				...
				<FormInput
					labelValue={password}
					// @ts-ignore
					onChangeText={(userPassword: React.SetStateAction<undefined>) => setPassword(userPassword)}
